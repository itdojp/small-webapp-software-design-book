...
- まず 1 本の主要導線について、[Appendix B（B-3）]({{ '/appendix/B-templates/' | relative_url }}) で受け入れ条件・例外系・観測点を 1 ページに固定します
- 次に [Appendix B（B-8）]({{ '/appendix/B-templates/' | relative_url }}) で単体/統合/E2E の配分を決め、未検証のリスクと過剰な E2E を同時に見つけます
- AI を使ってテスト観点の洗い出しやレビュー観点のたたき台を作る場合は、関連教材 [ai-testing-strategy-book](https://github.com/itdojp/ai-testing-strategy-book) を参照すると、本章の配分判断をそのままプロンプト設計やレビュー手順へ接続できます
